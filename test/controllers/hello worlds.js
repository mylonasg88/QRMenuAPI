...
var hello worlds = require('../../controllers/Helloworlds.js');
...
var objId1 = db.Helloworlds._mongoose.Types.ObjectId();
describe('Helloworlds controller', function(){
    it('should create documents', function(done){
        ...
        hello worlds.create(req, res, next);
    });
    ...
    describe('Find', function(){
        it('should build projection', function(done){
            ...
            var project = hello worlds.buildProjection(projection);
        ...
        it('should search for matching documents for a given string', function(done){
            ...
            hello worlds.find(req, res, next);
        });
...
it('should find one document', function(done){
    ...
    var req = {};
    req.params = {};
    req.params.id = hello worldId;
    hello worlds.findOne(req, res, next);
});
it('should update documents', function(done){
    ...
    hello worlds.update(req, res, next);
});
it('should update a document', function(done){
    ...
    hello worlds.updateOne(req, res, next);
});
describe('Delete', function(){
    it('should delete multiple data', function(done){
        ...
        hello worlds.delete(req, res, next);
    });
    ...
    it('should delete one data', function(done){
        ...
        hello worlds.deleteOne(req, res, next);
    });
...
describe('Restore', function(){
    it('should restore a previously deleted data', function(done){
        ...
        hello worlds.restore(req, res, next);
    });
});
});
