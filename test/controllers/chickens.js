...
var chickens = require("../../api/src/controllers/Chickens.js");
...
var objId1 = db.Chickens._mongoose.Types.ObjectId();
describe("Chickens controller", function () {
  ...
  describe("Find", function () {
    it("should build projection", function (done) {
      ...
      var project = chickens.buildProjection(projection);
      project.should.eventually.be.an("object");
      project.should.eventually.have.property("name");
      project.should.eventually.have
        .property("someOtherStringData")
        .notify(done);
    });
    ...
    it("should select just few parameters from the documents", function (done) {
      ...
      res.ok = function (data, cache, extraData) {
        ...
        console.log(data);
        expect(data[0].someOtherStringData).to.be
          .undefined; /* jslint ignore:line */
        done();
      };
      var req = {};
      req.query = {};
  ...
  it("should find one document", function (done) {
    ...
    var req = {};
    req.params = {};
    req.params.id = chickenId;
    chickens.findOne(req, res, next);
  });
  ...
  it("should update a document", function (done) {
    ...
    chickens.updateOne(req, res, next);
  });
  describe("Delete", function () {
    ...
    it("should delete one data", function (done) {
      ...
      chickens.deleteOne(req, res, next);
    });
